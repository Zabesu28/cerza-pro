...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 22 mars 2023 à 11:32
...
INSERT INTO `especes` (`idEspece`, `libelleEspece`, `regime`, `poids_min`, `poids_max`, `description`) VALUES
(1, 'Le Tatou', 'Fruits, herbe et insectes', 5, 5, NULL),
(2, 'L\'Axolotl', 'Crustacés', 60, 110, NULL),
(3, 'L\'Emeu d\'Australie', 'Omnivore', 30, 55, NULL),
(4, 'Le roulroul coronné', 'Fruits, insectes et vers', 250, 250, NULL);
